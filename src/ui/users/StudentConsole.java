...
import services.academic.TranscriptService;
...
public class StudentConsole implements ConsoleScreen {
        ...
        while (running) {
            ...
            switch (choice) {
                ...
                case "8":
                    ...
                    break;
                case "9":
                    new NewsConsole(scanner, student).start();
                    break;
                case "10":
                    viewSchedule();
                    break;
                ...
                case "12":
                    ...
                    break;
                case "13":
                    new JournalConsole(scanner, student).start();
                    break;
                case "14":
                    viewAttendance();
                    break;
    ...
    private void printMenu() {
        ...
        System.out.println("14. View attendance");
    ...
    private void viewAttendance() {
        List<String> rows = attendanceService.getAttendanceRows(student);
        if (rows.isEmpty()) {
            System.out.println("No attendance records found.");
            return;
        }
        System.out.printf("%-12s %-12s %-12s %-10s%n", "Date", "Course", "Type", "Status");
        for (String row : rows) {
