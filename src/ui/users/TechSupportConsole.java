...
public class TechSupportConsole implements ConsoleScreen {
        ...
        while (running) {
            ...
            switch (choice) {
                ...
                case "4":
                    ...
                    break;
                case "5":
                    new JournalConsole(scanner, specialist).start();
                    break;
                case "6":
    ...
    private void printMenu() {
        ...
        System.out.println("5. " + I18n.t("journal.title"));
    ...
    private void viewSupportRequests() {
        List<TechSupportRequest> requests = supportRequestService.viewNewRequests(specialist);
        if (requests.isEmpty()) {
