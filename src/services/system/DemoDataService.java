...
public class DemoDataService {
    ...
    public DemoDataService(UniversityDataStore dataStore) {
    ...
    public void seedDemoData() throws IOException {
        ...
        Course oop = getOrCreateCourse("CSCI2106", "Object-Oriented Programming and Design", 3, CourseType.MAJOR, 2, null);
        Course web = getOrCreateCourse("INF2205", "Web Development", 4, CourseType.MAJOR, 2, null);
        oop.setIntendedSchool(enums.School.SEOGI);
    ...
    private Student getOrCreateStudent() {
        ...
        student.setSchool(enums.School.SITE);
    ...
    private Teacher getOrCreateTeacher() {
        ...
        // Demo teacher: set as Professor and PhD to satisfy researcher rule
        teacher.setTeacherType(enums.TeacherType.PROFESSOR);
        teacher.setDegree(enums.Degree.PhD);
    ...
    private Course getOrCreateCourse(String code, String name, int credits, CourseType type, int year, enums.School intendedSchool) {
    ...
    private void seedOrganization(Student student) {
        for (StudentOrganization organization : dataStore.getStudentOrganizations()) {
            if ("Programming Club".equalsIgnoreCase(organization.getName())) {
                return;
            }
        }
